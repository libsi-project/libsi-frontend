...
class NeoDrawer extends StatelessComponent {
  ...
  static List<StyleRule> get stylesheets => [
    ...
    css('.neo-drawer-panel').styles(
      ...
      height: 100.percent,
      maxWidth: 85.percent,
      padding: Padding.symmetric(horizontal: 1.25.rem, vertical: 1.25.rem),
      border: Border.only(
        right: BorderSide.solid(width: NeoTokens.borderThick.px, color: AppTheme.borderColor),
      ),
      ...
      raw: {'box-shadow': '8px 0 0 0 var(--theme-border)'},
    ),
